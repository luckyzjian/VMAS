...
namespace VMAS1._0
{
    public partial class detectLine : Form
    {
        ...
        private void detectLine_Load(object sender, EventArgs e)
        {
            init_detectLineInf("", false);
            ref_WaitCar();
        }
        private void init_detectLineInf(string newdetectLinebh,bool displayOk)
        {
            newJiancexian childzyjspanel = new newJiancexian();
            ...
            this.panel2.Controls.Add(childzyjspanel);
            childzyjspanel.Show();
            if (displayOk)
                childzyjspanel.init_jcxInfor(newdetectLinebh);
        ...
        {
            init_detectLineInf(dataGrid_waitcar.SelectedRows[0].Cells["检测线编号"].Value.ToString(),true);
        }
    }
}
