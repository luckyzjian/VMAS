...
namespace carinfor
{
    ...
    public class fqyconfigIni
    {
        ...
        public fqyconfigInfdata getfqyConfigIni()
        {
            ...
            temp.Length = 2048;
            ini.INIIO.GetPrivateProfileString("废气仪标定", "高标气CO", "", temp, 2048,startUpPath+"/detectConfig.ini");
            if (float.TryParse(temp.ToString().Trim(), out a))
                fqyconfiginidata.Co_high = a;
            else
                fqyconfiginidata.Co_high = 8.0f;
            ini.INIIO.GetPrivateProfileString("废气仪标定", "高标气CO2", "", temp, 2048,startUpPath+"/detectConfig.ini");
            if (float.TryParse(temp.ToString().Trim(), out a))
                fqyconfiginidata.Co2_high = a;
            else
                fqyconfiginidata.Co2_high = 12.0f;
            ini.INIIO.GetPrivateProfileString("废气仪标定", "高标气NO", "", temp, 2048,startUpPath+"/detectConfig.ini");
            if (float.TryParse(temp.ToString().Trim(), out a))
                fqyconfiginidata.No_high = a;
            else
                fqyconfiginidata.No_high = 3000.0f;
            ini.INIIO.GetPrivateProfileString("废气仪标定", "高标气HC", "", temp, 2048,startUpPath+"/detectConfig.ini");
            if (float.TryParse(temp.ToString().Trim(), out a))
                fqyconfiginidata.Hc_high = a;
            else
                fqyconfiginidata.Hc_high = 3200.0f;
            ini.INIIO.GetPrivateProfileString("废气仪标定", "高标气O2", "", temp, 2048,startUpPath+"/detectConfig.ini");
            if (float.TryParse(temp.ToString().Trim(), out a))
                fqyconfiginidata.O2_high = a;
            else
                fqyconfiginidata.O2_high = 0.0f;

            ini.INIIO.GetPrivateProfileString("废气仪标定", "低标气CO", "", temp, 2048,startUpPath+"/detectConfig.ini");
            if (float.TryParse(temp.ToString().Trim(), out a))
                fqyconfiginidata.Co_low = a;
            else
                fqyconfiginidata.Co_low = 0.5f;
            ini.INIIO.GetPrivateProfileString("废气仪标定", "低标气CO2", "", temp, 2048,startUpPath+"/detectConfig.ini");
            if (float.TryParse(temp.ToString().Trim(), out a))
                fqyconfiginidata.Co2_low = a;
            else
                fqyconfiginidata.Co2_low = 3.6f;
            ini.INIIO.GetPrivateProfileString("废气仪标定", "低标气NO", "", temp, 2048,startUpPath+"/detectConfig.ini");
            if (float.TryParse(temp.ToString().Trim(), out a))
                fqyconfiginidata.No_low = a;
            else
                fqyconfiginidata.No_low = 300.0f;
            ini.INIIO.GetPrivateProfileString("废气仪标定", "低标气HC", "", temp, 2048,startUpPath+"/detectConfig.ini");
            if (float.TryParse(temp.ToString().Trim(), out a))
                fqyconfiginidata.Hc_low = a;
            else
                fqyconfiginidata.Hc_low = 200.0f;
            ini.INIIO.GetPrivateProfileString("废气仪标定", "低标气O2", "", temp, 2048,startUpPath+"/detectConfig.ini");
            if (float.TryParse(temp.ToString().Trim(), out a))
                fqyconfiginidata.O2_low = a;
            else
                fqyconfiginidata.O2_low = 0.0f;

            ini.INIIO.GetPrivateProfileString("废气仪标定", "零气CO", "", temp, 2048,startUpPath+"/detectConfig.ini");
            if (float.TryParse(temp.ToString().Trim(), out a))
                fqyconfiginidata.Co_zero = a;
            else
                fqyconfiginidata.Co_zero = 0f;
            ini.INIIO.GetPrivateProfileString("废气仪标定", "零气CO2", "", temp, 2048,startUpPath+"/detectConfig.ini");
            if (float.TryParse(temp.ToString().Trim(), out a))
                fqyconfiginidata.Co2_zero = a;
            else
                fqyconfiginidata.Co2_zero = 0f;
            ini.INIIO.GetPrivateProfileString("废气仪标定", "零气NO", "", temp, 2048,startUpPath+"/detectConfig.ini");
            if (float.TryParse(temp.ToString().Trim(), out a))
                fqyconfiginidata.No_zero = a;
            else
                fqyconfiginidata.No_zero = 00f;
            ini.INIIO.GetPrivateProfileString("废气仪标定", "零气HC", "", temp, 2048,startUpPath+"/detectConfig.ini");
            if (float.TryParse(temp.ToString().Trim(), out a))
                fqyconfiginidata.Hc_zero = a;
            else
                fqyconfiginidata.Hc_zero = 0f;
            ini.INIIO.GetPrivateProfileString("废气仪标定", "零气O2", "", temp, 2048,startUpPath+"/detectConfig.ini");
            if (float.TryParse(temp.ToString().Trim(), out a))
                fqyconfiginidata.O2_zero = a;
            else
                fqyconfiginidata.O2_zero = 20.9f;
            ini.INIIO.GetPrivateProfileString("废气仪标定", "PEF", "", temp, 2048,startUpPath+"/detectConfig.ini");
            if (float.TryParse(temp.ToString().Trim(), out a))
                fqyconfiginidata.PEF = a;
            else
                fqyconfiginidata.PEF = 0.525f;
