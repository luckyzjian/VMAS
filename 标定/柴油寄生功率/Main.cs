       ...
       /*private void button_demarcate_force_Click(object sender, EventArgs e)
        ...
        private void button_addbdd_Click(object sender, EventArgs e)
        {
	        ...
	        {	        
                ...
                if (Math.Abs(float.Parse(textBox_bdd.Text.Trim()) - float.Parse(label_yzl.Text.Trim())) * 100.0 / float.Parse(textBox_bdd.Text.Trim()) > 2)
                {
                    dr["判定"] = "不合格";
                }
                else
        ...
        private void comboBox4_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            ini.INIIO.GetPrivateProfileString("UseMK", Aisle, "0.0", temp, 2048,startUpPath+"/detectConfig.ini");    //读配置文件（段名，字段，默认值，保存的strbuilder，大小，路径）
