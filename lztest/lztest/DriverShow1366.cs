...
namespace lzTest
{
    public partial class DriverShow1366 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            Msg(labelTs1, panelts1, Lz_Btg.ts1, false);
            Msg(labelts2, panelTs2, Lz_Btg.ts2, false);
            timer1.Start();
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            Msg(labelTs1, panelts1, Lz_Btg.ts1, false);
            Msg(labelts2, panelTs2, Lz_Btg.ts2, false);
            Msg(labelSpeed, panelSpeed, Lz_Btg.ZS.ToString("0"), false);
            Msg(labeldata1, paneldata1, Lz_Btg.data1, false);
            Msg(labeldata2, paneldata2, Lz_Btg.data2, false);
            Msg(labeldata3, paneldata3, Lz_Btg.data3, false);
            Msg(labeldata4, paneldata4, Lz_Btg.data4, false);            
        }
    }
}
