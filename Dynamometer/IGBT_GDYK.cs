                ...
                if (All_Content_byte.Count > 17)
                {
                    ...
                    try
                    {
                        ...
                        if (All_Content_byte.Count > 0)
                        {
                            ...
                            /*Speed_string = Speed_single.ToString("0.00");
                            Force_string = Force_single.ToString("0");
                            Speed = Speed_single;
                            Force = Force_single;
                            ...
                            if (force_list.Count >= 40)
                            {
                                ...
                                if (caculate_count == 5)
                                {
                                    Speed_string = (speed_sum / 40f).ToString("0.00");
